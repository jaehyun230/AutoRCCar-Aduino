...
class NeuralNetwork():
    def __init__(self):
        self.model = cv2.ml.ANN_MLP_load('D:\\SelfDrivingRCCar-master\\server\\mlp_xml\\mlp_1504380896.xml')
...
class VideoStreamHandler(socketserver.StreamRequestHandler):
    ...
    light_classifier = cv2.CascadeClassifier('D:\\SelfDrivingRCCar-master\\server\\cascade_classifiers\\traffic_light.xml')
