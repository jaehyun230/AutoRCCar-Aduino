...
class NeuralNetwork():
    def __init__(self):
        self.model = cv2.ml.ANN_MLP_load('D:\\SelfDrivingRCCar-masterTest2\\server\\mlp_xml\\mlp_1506241525.xml')
...
class VideoStreamHandler(socketserver.StreamRequestHandler):
    # Cascade Classifiers
    stop_classifier = cv2.CascadeClassifier('D:\\SelfDrivingRCCar-masterTest2\\server\\cascade_classifiers\\stop_sign.xml')
    light_classifier = cv2.CascadeClassifier('D:\\SelfDrivingRCCar-masterTest2\\server\\cascade_classifiers\\traffic_light.xml')
...
#                if v_stop != None or v_light !=None:
